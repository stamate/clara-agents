actions = {
    ...
    "DETECT_AGENT_PRIVILEGES": [
        {
            "message": "Get the current user's privileges on the active Clara agent using a Powershell command.",
            "summary_method": "last_msg",
    ...
    "COLLECT_CLARA_INFO": [
        {
            "message": "Get the ID of the active Clara operation.",
            "summary_method": "last_msg",
            "carryover": "Replace this placeholder with the ID of the active Clara operation.",
            "agent": "clara_agent",
        },
        {
            "message": "Get the PAW of the active Clara agent by calling /api/v2/agents.",
            "summary_method": "last_msg",
            "carryover": "Replace this placeholder with the PAW of the active Clara agent.",
            "agent": "clara_agent",
        },
    ],
    ...
    "DETECT_EDR": [
        ...
        {
            "message": "List all Windows services on the active Clara agent",
            "summary_method": "last_msg",
            "carryover": "Replace this placeholder with the list of ALL Windows service names",
            "agent": "clara_agent",
        },
        {
            "message": """Identify which security services are likely running on the active Clara agent based on the provided context.
    ...
    "HELLO_CLARA": [
        {
            "message": "Use powershell to display a message box on the desktop of the active Clara agent containing a cyber security joke.",
            "summary_method": "last_msg",
            "agent": "clara_agent",
        }
    ],
    ...
    "TTP_REPORT_TO_ADVERSARY_PROFILE": [
        ...
        {
            "message": "For each one of the MITRE techniques that was extracted from the report find a matching Clara ability based on the technique id. Do not truncate the output.",
            "summary_method": "last_msg",
            "carryover": "Replace this placeholder with the matched Clara abilities",
            "agent": "clara_agent",
        },
        {
            "message": "Create a new adversary profile with an appropriate name according to the report contents and add one matched Clara ability per technique",
            "summary_method": "last_msg",
...
scenarios = {
    ...
    "HELLO_CLARA": ["COLLECT_CLARA_INFO", "HELLO_CLARA"],
    "COLLECT_CLARA_INFO": ["COLLECT_CLARA_INFO"],
    "DETECT_EDR": ["COLLECT_CLARA_INFO", "DETECT_EDR"],
    "DETECT_AGENT_PRIVILEGES": ["COLLECT_CLARA_INFO", "DETECT_AGENT_PRIVILEGES"],
